...
public class AdsScript : MonoBehaviour
{
    ...
    public void ShowRewardAdsForCharacter()
    {
        ShowAd(Placements.UnlockCharacter);
    }
    ...
    {
        if (placement == Placements.UnlockCharacter.ToString())
        {
            //reward
            FindObjectOfType<CharacterMenuUI>().UnlockCharacter();
            _noRewardAdsTimer = _noRewardAdsDelay;
        }
    }
